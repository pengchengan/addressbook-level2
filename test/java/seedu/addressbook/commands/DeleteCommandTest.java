...
public class DeleteCommandTest {
    ...
    public void setUp() throws Exception {
        Person johnDoe = new Person(new Name("John Doe"), new Phone("61234567", false),
                new Email("john@doe.com", false), new Address("395C, Ben Road, unit1, postal1", false), new UniqueTagList());
        Person janeDoe = new Person(new Name("Jane Doe"), new Phone("91234567", false),
                new Email("jane@doe.com", false), new Address("33G, Ohm Road, unit2, postal2", false), new UniqueTagList());
        Person samDoe = new Person(new Name("Sam Doe"), new Phone("63345566", false),
                new Email("sam@doe.com", false), new Address("55G, Abc Road, unit2, postal2", false), new UniqueTagList());
        Person davidGrant = new Person(new Name("David Grant"), new Phone("61121122", false),
                new Email("david@grant.com", false), new Address("44H, Define Road, unit2, postal2", false),
                new UniqueTagList());
    ...
    public void execute_targetPersonNotInAddressBook_returnsPersonNotFoundMessage()
        ...
        Person notInAddressBookPerson = new Person(new Name("Not In Book"), new Phone("63331444", false),
                new Email("notin@book.com", false), new Address("156D, Grant Road, unit2, postal2", false), new UniqueTagList());
